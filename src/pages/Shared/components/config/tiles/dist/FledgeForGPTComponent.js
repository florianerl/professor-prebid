...
var FledgeForGPTComponent = function () {
    ...
    var fledgeForGpt = prebid.config.fledgeForGpt;
    ...
    return (react_1["default"].createElement(Grid_1["default"], { size: { xs: 12, sm: maxWidth }, ref: ref },
        react_1["default"].createElement(Card_1["default"], { sx: { width: 1, minHeight: ConfigComponent_1.tileHeight, maxHeight: expanded ? 'unset' : ConfigComponent_1.tileHeight } },
            react_1["default"].createElement(CardHeader_1["default"], { avatar: react_1["default"].createElement(Avatar_1["default"], { sx: { bgcolor: 'primary.main' } },
                    react_1["default"].createElement(BorderBottom_1["default"], null)), title: react_1["default"].createElement(Typography_1["default"], { variant: "h3" }, "Fledge For GPT Module"), subheader: react_1["default"].createElement(Typography_1["default"], { variant: "subtitle1" }, !expanded && react_1["default"].createElement(RenderKeyValueComponent_1["default"], { label: "Enabled", value: fledgeForGpt.enabled, columns: [12, 12], expanded: expanded })), action: react_1["default"].createElement(ExpandMore_1["default"], { sx: {
                        transform: !expanded ? 'rotate(0deg)' : 'rotate(180deg)',
                        marginLeft: 'auto'
                    } }), onClick: handleExpandClick }),
            react_1["default"].createElement(CardContent_1["default"], null,
                react_1["default"].createElement(Grid_1["default"], { container: true, spacing: 2 },
                    !expanded && react_1["default"].createElement(RenderKeyValueComponent_1["default"], { label: "Default For Slots", value: fledgeForGpt.defaultForSlots || 'undefined', columns: [12, 12], expanded: expanded }),
                    !expanded && react_1["default"].createElement(RenderKeyValueComponent_1["default"], { label: "Bidders", value: fledgeForGpt.bidders || 'all bidders', columns: [12, 12], expanded: expanded }),
                    expanded && react_1["default"].createElement(RenderKeyValueComponent_1["default"], { label: "Module Configuration", value: fledgeForGpt, columns: [12, 12], expanded: expanded }))))));
};
exports["default"] = FledgeForGPTComponent;
