              ...
              {slotResponseInfo && (
                <Grid>
                  <Paper elevation={1} sx={{ p: inPopOver ? 1 : 0.5 }}>
                    ...
                    <JSONViewerComponent name={false} src={slotResponseInfo} collapsed={false} displayObjectSize={true} displayDataTypes={false} sortKeys={false} quotesOnKeys={false} indentWidth={2} collapseStringsAfterLength={100} />
                  </Paper>
                </Grid>
              )}
