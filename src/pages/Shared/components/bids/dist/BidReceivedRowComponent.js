...
var BidReceivedRowComponent = function (_a) {
    var _b;
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        ...
        react_1["default"].createElement(Grid_1["default"], { size: { xs: 2.38 } },
            react_1["default"].createElement(Paper_1["default"], { sx: { height: 1 } },
                react_1["default"].createElement(Typography_1["default"], { variant: "body1" },
                    bid.bidder,
                    " "))),
        react_1["default"].createElement(Grid_1["default"], { size: { xs: 1 } },
            react_1["default"].createElement(Paper_1["default"], { sx: { height: 1 } },
                react_1["default"].createElement(Typography_1["default"], { variant: "body1" }, bid.cpm ? Math.floor(bid.cpm * 100) / 100 : bid.cpm))),
        react_1["default"].createElement(Grid_1["default"], { size: { xs: 2 } },
            react_1["default"].createElement(Paper_1["default"], { sx: { height: 1 } },
                react_1["default"].createElement(Typography_1["default"], { variant: "body1" }, bid.currency))),
        ...
        react_1["default"].createElement(Grid_1["default"], { size: { xs: 1 } },
            react_1["default"].createElement(Paper_1["default"], { sx: { height: 1 } },
                react_1["default"].createElement(Typography_1["default"], { variant: "body1" }, bid.size))),
        react_1["default"].createElement(Grid_1["default"], { size: { xs: 2 } },
            react_1["default"].createElement(Paper_1["default"], { sx: { height: 1 } },
                react_1["default"].createElement(Typography_1["default"], { variant: "body1" },
                    " ",
...
exports["default"] = BidReceivedRowComponent;
