...
describe('MessageHandler', () => {
  ...
  it('handles GAM payload', async () => {
    const payload: IGoogleAdManagerDetails = { slots: [] };
    await handler.handle({ type: EVENTS.SEND_GAM_DETAILS_TO_BACKGROUND, payload }, { tab: { id: 1 } });
  ...
  it('handles Prebid payload', async () => {
    ...
    await handler.handle({ type: EVENTS.SEND_PREBID_DETAILS_TO_BACKGROUND, payload }, { tab: { id: 2 } });
  ...
  it('handles TCF payload', async () => {
    ...
    await handler.handle({ type: EVENTS.SEND_TCF_DETAILS_TO_BACKGROUND, payload }, { tab: { id: 3 } });
